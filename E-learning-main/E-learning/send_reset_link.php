    ...
    if (isset($_POST["username"])) {
        ...
        if (checkUsername($conn, $username)) {
            ...
            if ($result->num_rows > 0) {
                ...
                $mail->Body = "<p>Here is your link to reset passwort: <a href='http://localhost:24000/handle_forgot_password.php?p=" . $username . "&&v=" . $redis->get($username) . "'>link to reset password</a></p><p>If you have any problems, please contact us via email: elearninghust@gmail.com</p>";
                $mail->send();
